...
VALUES
  ...
  (2, '2015-10-21 07:00:00', 'CREATE', 'de.rwth.dbis.acis.bazaar.service.BazaarService', 'http://localhost:8080/bazaar/categories/1', 'CATEGORY',
  ...
  (3, '2015-10-21 08:00:00', 'CREATE', 'de.rwth.dbis.acis.bazaar.service.BazaarService', 'http://localhost:8080/bazaar/requirements/1', 'REQUIREMENT',
  ...
  (4, '2015-10-21 09:00:00', 'UPDATE', 'de.rwth.dbis.acis.bazaar.service.BazaarService', 'http://localhost:8080/bazaar/requirements/1', 'REQUIREMENT',
   'http://localhost:5000/#!/projects/1/categories/1/requirements/1', 'http://localhost:8080/bazaar/categories/1',
   'CATEGORY', 'http://localhost:8080/bazaar/users/2'),
  ...
  (6, '2015-10-21 10:00:00', 'CREATE', 'de.rwth.dbis.acis.bazaar.service.BazaarService', 'http://localhost:8080/bazaar/projects/2', 'PROJECT',
   'http://localhost:5000/#!/projects/2', NULL, NULL, 'http://localhost:8080/bazaar/users/2'),
  (7, '2015-10-21 10:00:00', 'CREATE', 'de.rwth.dbis.acis.bazaar.service.BazaarService', 'http://localhost:8080/bazaar/categories/2', 'CATEGORY',
   'http://localhost:5000/#!/projects/2/categories/2', 'http://localhost:8080/bazaar/projects/2',
   'PROJECT', 'http://localhost:8080/bazaar/users/2'),
  (8, '2015-10-21 11:00:00', 'CREATE', 'de.rwth.dbis.acis.bazaar.service.BazaarService', 'http://localhost:8080/bazaar/requirements/2', 'REQUIREMENT',
   'http://localhost:5000/#!/projects/1/categories/1/requirements/1', 'http://localhost:8080/bazaar/categories/1',
   'CATEGORY', 'http://localhost:8080/bazaar/users/2'),
  (9, '2015-10-21 12:00:00', 'UPDATE', 'de.rwth.dbis.acis.bazaar.service.BazaarService', 'http://localhost:8080/bazaar/requirements/2', 'REQUIREMENT',
   'http://localhost:5000/#!/projects/1/categories/1/requirements/1', 'http://localhost:8080/bazaar/categories/1',
   'CATEGORY', 'http://localhost:8080/bazaar/users/2'),
  (10, '2015-10-21 13:00:00', 'CREATE', 'de.rwth.dbis.acis.bazaar.service.BazaarService', 'http://localhost:8080/bazaar/comments/1', 'COMMENT',
  ...
  (11, '2015-10-21 14:00:00', 'CREATE', 'de.rwth.dbis.acis.bazaar.service.BazaarService', 'http://localhost:8080/bazaar/comments/2', 'COMMENT',
