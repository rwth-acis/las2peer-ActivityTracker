...
public class Activity extends TableImpl<ActivityRecord> {
    ...
    private static final long serialVersionUID = 1356905870;
    ...
    /**
     * The column <code>reqbaztrack.activity.origin</code>.
     */
    public final TableField<ActivityRecord, String> ORIGIN = createField("origin", org.jooq.impl.SQLDataType.VARCHAR.length(255).nullable(false), this, "");
     ...
     */
    public final TableField<ActivityRecord, String> DATA_TYPE = createField("data_type", org.jooq.impl.SQLDataType.VARCHAR.length(255), this, "");
